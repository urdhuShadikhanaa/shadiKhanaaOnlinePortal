...
import getHealthScoreForAccountPlan from '@salesforce/apex/HealthScoreController.getTotalHealthScoreForAccountPlan';

import { formatLabel } from 'c/stringUtils';
import Points_Breakdown_Label from '@salesforce/label/c.Points_Breakdown';
export default class PqScoreTotal extends LightningElement {
    @api recordId;
                ...
                datasets: [
                    {
                        ...
                        data: [scoreWrapper.points, scoreWrapper.maxPoints - scoreWrapper.points]
                    }
                ]
            },
            options: {
