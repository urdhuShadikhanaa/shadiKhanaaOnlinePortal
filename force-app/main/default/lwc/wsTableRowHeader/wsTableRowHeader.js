...
export default class WsTableRowHeader extends LightningElement {
    @api rowIndex;
    ...
    @api get currentStyle() {
        let style = 'ws-row-header ws-row-header-block';
    ...
    handleMouseOver() {
        // Fire event that this parent header is highlighted.  Handled by child row headers and cells.
        this.dispatchEvent(
